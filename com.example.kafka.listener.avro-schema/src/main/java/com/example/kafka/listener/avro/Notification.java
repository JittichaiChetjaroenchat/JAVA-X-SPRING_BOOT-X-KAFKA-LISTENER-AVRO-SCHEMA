 ...
 */
package com.example.kafka.listener.avro;
...
public class Notification extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -767819204534306948L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Notification\",\"namespace\":\"com.example.kafka.listener.avro\",\"fields\":[{\"name\":\"recipientId\",\"type\":\"string\"},{\"name\":\"channel\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"}]}");
   ...
   */
  public Notification(java.lang.CharSequence recipientId, java.lang.CharSequence channel, java.lang.CharSequence message) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: recipientId = (java.lang.CharSequence)value$; break;
   ...
   */
  public static com.example.kafka.listener.avro.Notification.Builder newBuilder() {
    return new com.example.kafka.listener.avro.Notification.Builder();
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static com.example.kafka.listener.avro.Notification.Builder newBuilder(com.example.kafka.listener.avro.Notification.Builder other) {
    if (other == null) {
      return new com.example.kafka.listener.avro.Notification.Builder();
    } else {
      return new com.example.kafka.listener.avro.Notification.Builder(other);
    }
  }
   ...
   * @return A new Notification RecordBuilder
   */
  public static com.example.kafka.listener.avro.Notification.Builder newBuilder(com.example.kafka.listener.avro.Notification other) {
    if (other == null) {
      return new com.example.kafka.listener.avro.Notification.Builder();
    } else {
      return new com.example.kafka.listener.avro.Notification.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Notification>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka.listener.avro.Notification.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.recipientId)) {
        this.recipientId = data().deepCopy(fields()[0].schema(), other.recipientId);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka.listener.avro.Notification other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.recipientId)) {
        this.recipientId = data().deepCopy(fields()[0].schema(), other.recipientId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.listener.avro.Notification.Builder setRecipientId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.listener.avro.Notification.Builder clearRecipientId() {
      recipientId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.listener.avro.Notification.Builder setChannel(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.listener.avro.Notification.Builder clearChannel() {
      channel = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.listener.avro.Notification.Builder setMessage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.listener.avro.Notification.Builder clearMessage() {
      message = null;
    ...
    public Notification build() {
      try {
        ...
        record.recipientId = fieldSetFlags()[0] ? this.recipientId : (java.lang.CharSequence) defaultValue(fields()[0]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.recipientId = in.readString(this.recipientId instanceof Utf8 ? (Utf8)this.recipientId : null);
